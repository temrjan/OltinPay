...
from sqlalchemy import DateTime, ForeignKey, Index, Integer, JSON, Numeric, String, Boolean, Text, text
...
class Balance(Base):
    ...
    __table_args__ = (
        Index("ix_balances_user_asset", "user_id", "asset", unique=True),
    )
...
class Transaction(Base):
    ...
    type: Mapped[str] = mapped_column(String(20), nullable=False)  # deposit, withdraw, buy, sell, transfer
